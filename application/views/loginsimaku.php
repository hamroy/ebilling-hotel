...
<head>
  ...
  <meta name="description" content="Apliksi billing hotel berbasis web">
  <meta name="author" content="hamroy,sediakoding.com,sediapp">
  <!-- Fav and touch icons -->
  ...
  <div class="navbar navbar-warning navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
        ...
        <a class="brand text-center" href="#"><img src="<?= base_url() ?>images/<?= $logo ?>.png" class="img-thumbnail" width="40" alt="Logo Sediapp" /> | <span class="text-info"><?= $namapt ?> </span> </a>
      </div>
    </div>
  </div>
